...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
		...
		<tr>			
			...
			<td width="100px"><input type="submit" class="button" value="Ping" onclick="document.getElementById('send').value='Ping';"></td>
			<td></td>
		</tr>
		<tr>			
			<td>&nbsp;</td>
		...
		<tr>			
			...
			<td width="100px"><input type="submit" class="button" value="{php}echo _tr('Traceroute');{/php}" onclick="document.getElementById('send').value='Traceroute';"></td>
			<td></td>
		</tr>		
...
<table class="tabForm" style="font-size: 16px;" cellspacing="0" cellpadding="0" width="100%">
		<tr><td align="left" colspan="2"><b>{php}echo _tr('Report');{/php}</b></td></tr>
